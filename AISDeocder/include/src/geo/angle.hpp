#ifndef src__GEO__ANGLE__HPP
#define src__GEO__ANGLE__HPP
...
//latitude _lat(long double value){
//    return latitude{static_cast<double>(value)};
//}

//latitude _north(long double value){
//    return latitude{static_cast<double>(value)};
//}

//latitude _south(long double value){
//    return latitude{static_cast<double>(-value)};
//}
...
//longitude _lon(long double value){
//    return longitude{static_cast<double>(value)};
//}

//longitude _east(long double value){
//    return longitude{static_cast<double>(value)};
//}

//longitude _west(long double value){
//    return longitude{static_cast<double>(-value)};
//}
