...
namespace ais
{
void binary_001_12::read_from(const raw & payload)
{
...
void binary_001_12::write_to(raw & payload) const
{
...
utils::optional<geo::position> binary_001_12::get_position() const
{
...
utils::optional<uint32_t> binary_001_12::get_day() const
{
...
utils::optional<uint32_t> binary_001_12::get_hour() const
{
...
utils::optional<uint32_t> binary_001_12::get_minute() const
{
...
utils::optional<uint32_t> binary_001_12::get_wind_speed_avg() const
{
...
utils::optional<uint32_t> binary_001_12::get_wind_gust() const
{
...
utils::optional<uint32_t> binary_001_12::get_wind_direction() const
{
...
utils::optional<uint32_t> binary_001_12::get_wind_gust_direction() const
{
...
utils::optional<double> binary_001_12::get_temperature() const
{
...
utils::optional<uint32_t> binary_001_12::get_humidity() const
{
...
utils::optional<double> binary_001_12::get_dew_point() const
{
...
utils::optional<uint32_t> binary_001_12::get_pressure() const
{
...
utils::optional<binary_001_12::trend> binary_001_12::get_pressure_trend() const
{
...
utils::optional<double> binary_001_12::get_visibility() const
{
...
utils::optional<double> binary_001_12::get_water_level() const
{
...
utils::optional<binary_001_12::trend> binary_001_12::get_water_level_trend() const
{
...
utils::optional<double> binary_001_12::get_surface_current_speed() const
{
...
utils::optional<uint32_t> binary_001_12::get_surface_current_direction() const
{
...
/// Returns the speed in knots.
utils::optional<double> binary_001_12::get_current_2_speed() const
{
...
utils::optional<uint32_t> binary_001_12::get_current_2_direction() const
{
...
utils::optional<uint32_t> binary_001_12::get_current_2_depth() const
{
...
/// Returns the speed in knots.
utils::optional<double> binary_001_12::get_current_3_speed() const
{
...
utils::optional<uint32_t> binary_001_12::get_current_3_direction() const
{
...
utils::optional<uint32_t> binary_001_12::get_current_3_depth() const
{
...
utils::optional<double> binary_001_12::get_wave_height() const
{
...
utils::optional<uint32_t> binary_001_12::get_wave_period() const
{
...
utils::optional<uint32_t> binary_001_12::get_wave_direction() const
{
...
utils::optional<double> binary_001_12::get_swell_height() const
{
...
utils::optional<uint32_t> binary_001_12::get_swell_period() const
{
...
utils::optional<uint32_t> binary_001_12::get_swell_direction() const
{
...
utils::optional<uint32_t> binary_001_12::get_sea_state() const
{
...
utils::optional<double> binary_001_12::get_water_temperature() const
{
...
utils::optional<binary_001_12::precipitation> binary_001_12::get_precipitation() const
{
...
utils::optional<double> binary_001_12::get_salinity() const
{
...
utils::optional<binary_001_12::ice> binary_001_12::get_ice() const
{
...
void binary_001_12::set_position(utils::optional<geo::position> t)
{
	if (!t) {
...
void binary_001_12::set_day(utils::optional<uint32_t> t)
{
...
/// A value out of range is treated the same as an empty optional.
void binary_001_12::set_hour(utils::optional<uint32_t> t)
{
...
/// A value out of range is treated the same as an empty optional.
void binary_001_12::set_minute(utils::optional<uint32_t> t)
{
	minute = (!t || *t > 59u) ? minute_not_available : *t;
}

void binary_001_12::set_wind_speed_avg(utils::optional<uint32_t> t)
{
	wind_speed_avg = !t ? wind_speed_avg_not_available : *t;
}

void binary_001_12::set_wind_gust(utils::optional<uint32_t> t)
{
	wind_gust = !t ? wind_gust_not_available : *t;
}

void binary_001_12::set_wind_direction(utils::optional<uint32_t> t)
{
	wind_direction = !t ? wind_direction_not_available : *t;
}

void binary_001_12::set_wind_gust_direction(utils::optional<uint32_t> t)
{
	wind_gust_direction = !t ? wind_gust_direction_not_available : *t;
}

void binary_001_12::set_temperature(utils::optional<double> t)
{
	temperature
		= !t ? temperature_not_available : static_cast<uint32_t>(std::round(*t / 0.1 + 60.0));
}

void binary_001_12::set_humidity(utils::optional<uint32_t> t)
{
	humidity = !t ? humidity_not_available : *t;
}

void binary_001_12::set_dew_point(utils::optional<double> t)
{
	dew_point
		= !t ? dew_point_not_available : static_cast<uint32_t>(std::round(*t / 0.1 + 20.0));
}

void binary_001_12::set_pressure(utils::optional<uint32_t> t)
{
	pressure = !t ? pressure_not_available : *t - 800;
}

void binary_001_12::set_pressure_trend(utils::optional<binary_001_12::trend> t)
{
	pressure_trend = !t ? trend::not_available : *t;
}

void binary_001_12::set_visibility(utils::optional<double> t)
{
	visibility = !t ? visibility_not_available : static_cast<uint32_t>(std::round(*t / 0.1));
}

void binary_001_12::set_water_level(utils::optional<double> t)
{
	water_level
		= !t ? water_level_not_available : static_cast<uint32_t>(std::round(*t / 0.1 + 10.0));
}

void binary_001_12::set_water_level_trend(utils::optional<binary_001_12::trend> t)
{
	water_level_trend = !t ? trend::not_available : *t;
}

void binary_001_12::set_surface_current_speed(utils::optional<double> t)
{
	surface_current_speed
		= !t ? current_speed_not_available : static_cast<uint32_t>(std::round(*t / 0.1));
}

void binary_001_12::set_surface_current_direction(utils::optional<uint32_t> t)
{
	surface_current_direction = !t ? current_direction_not_available : *t;
}

void binary_001_12::set_current_2_speed(utils::optional<double> t)
{
	current_2_speed
		= !t ? current_speed_not_available : static_cast<uint32_t>(std::round(*t / 0.1));
}

void binary_001_12::set_current_2_direction(utils::optional<uint32_t> t)
{
	current_2_direction = !t ? current_direction_not_available : *t;
}

void binary_001_12::set_current_2_depth(utils::optional<uint32_t> t)
{
	current_2_depth = !t ? current_depth_not_available : *t;
}

void binary_001_12::set_current_3_speed(utils::optional<double> t)
{
	current_3_speed
		= !t ? current_speed_not_available : static_cast<uint32_t>(std::round(*t / 0.1));
}

void binary_001_12::set_current_3_direction(utils::optional<uint32_t> t)
{
	current_3_direction = !t ? current_direction_not_available : *t;
}

void binary_001_12::set_current_3_depth(utils::optional<uint32_t> t)
{
	current_3_depth = !t ? current_depth_not_available : *t;
}

void binary_001_12::set_wave_height(utils::optional<double> t)
{
	wave_height = !t ? wave_height_not_available : static_cast<uint32_t>(std::round(*t / 0.1));
}

void binary_001_12::set_wave_period(utils::optional<uint32_t> t)
{
	wave_period = !t ? wave_period_not_available : *t;
}

void binary_001_12::set_wave_direction(utils::optional<uint32_t> t)
{
	wave_direction = !t ? wave_direction_not_available : *t;
}

void binary_001_12::set_swell_height(utils::optional<double> t)
{
	swell_height = !t ? wave_height_not_available : static_cast<uint32_t>(std::round(*t / 0.1));
}

void binary_001_12::set_swell_period(utils::optional<uint32_t> t)
{
	swell_period = !t ? wave_period_not_available : *t;
}

void binary_001_12::set_swell_direction(utils::optional<uint32_t> t)
{
	swell_direction = !t ? wave_direction_not_available : *t;
}

void binary_001_12::set_sea_state(utils::optional<uint32_t> t)
{
	sea_state = !t ? sea_state_not_available : *t;
}

void binary_001_12::set_water_temperature(utils::optional<double> t)
{
	water_temperature = !t ? water_temperature_not_available
						   : static_cast<uint32_t>(std::round(*t / 0.1 + 10.0));
}

void binary_001_12::set_precipitation(utils::optional<binary_001_12::precipitation> t)
{
	precipitation_type = !t ? precipitation::not_available : *t;
}

void binary_001_12::set_salinity(utils::optional<double> t)
{
	sailinity = !t ? salinity_not_available : static_cast<uint32_t>(std::round(*t / 0.1));
}

void binary_001_12::set_ice(utils::optional<binary_001_12::ice> t)
{
