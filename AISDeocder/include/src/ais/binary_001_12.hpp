#ifndef src__AIS__BINARY_001_12__HPP
#define src__AIS__BINARY_001_12__HPP

#include <src/ais/binary_data.hpp>
...
///
class binary_001_12 final : public binary_data
{
public:
...
private:
    ...
    bitset_value< 56 - MSG08_HEAD, 1, bool     > routeStart=false;
    bitset_value< 57 - MSG08_HEAD, 28, uint32_t             > longitude_minutes = longitude_not_available; // in 10000 minutes
    bitset_value< 89 - MSG08_HEAD, 27, uint32_t             > latitude_minutes = latitude_not_available; // in 10000 minutes
