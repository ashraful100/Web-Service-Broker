	...
	*/
	namespace Frame
	{
		...
		*/
        ...
        @detailed Implement main methods for serializing and deserializing raw frame data. All frames start with a 7-octet header composed of a type field (octet), a channel field (short integer) and a
		...
		*/			
        ...
        @detailed Implement main methods for serializing and deserializing raw method frame data.
		...
		*/
        ...
        @detailed Implement main methods for serializing and deserializing raw content frame data.
		...
		*/
		...
		public:
			...
			*/
            ...
            @detailed Constructs frame content header class for sending.
			*/
			Content();
            ...
            @detailed Constructs frame content header class for sending.
            @param methodClass defines method class Id of constructed frame.
			*/
